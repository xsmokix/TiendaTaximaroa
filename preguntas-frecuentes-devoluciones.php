...
[type="checkbox"]:not(:checked):focus + label:before {
      ...
      <div class="container">
        ...
        <div class="row">
           <div class="col-lg-4">
            ...
            <a href="preguntas-frecuentes-facturacion.php"><h1 class="faqs text-center"><i class="fas fa-truck"></i><br>Facturación</h1></a> <br>
            <a href="preguntas-frecuentes-compra.php"><h1 class="faqs text-center"><i class="fas fa-shopping-cart"></i><br>Compra</h1></a>     <br>     
            <a href="preguntas-frecuentes-envios.php"><h1 class="faqs text-center"><i class="fas fa-truck"></i><br>Envío</h1></a>
          
         </div>

         <div class="col-lg-8">
           <center><h1 class="mb-0 textoAzul">DEVOLUCIONES</h1></center>
           <br><br>
  ...
  <div class="accordion">
       <?php 
          $preguntas = $con->query("SELECT * FROM preguntas_frecuentes WHERE categoria='devoluciones' AND estado='1'");  
