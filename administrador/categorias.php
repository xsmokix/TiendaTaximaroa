              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="submenu.php?idmenu=<?php echo $rowcategorias->id; ?>" class="btn btn-default">Ver/Crear Subcategoría</a>
                    </td>
                    <td class="text-right">
                      <?php 
                      if ($estado=="success") {
                        ...
                        ?><button onclick="activarCategoria('<?php echo $rowcategorias->id; ?>'); return false;" class="btn-xs btn-success">Activar</button><?php
                       } ?>
                      <a href="categorias_modificar.php?idcategoria=<?php echo $rowcategorias->id; ?>" class="btn-xs btn-warning">Modificar</a>
            ...
            <br>
              ...
              <form id="formcategoria" class="form-horizontal" enctype="multipart/form-data" method="post"  action="guardar.php" >
                ...
                <div class="form-inputs">
                  ...
                  <input type="text" id="nombre" name="nombre" class="form-control input-lg" placeholder="Nombre categoria" required>
                  <input type="text" name="icono" class="form-control input-lg" placeholder="Icono" required><a href="https://fontawesome.com/icons?d=gallery&p=2" target="_blank">Revisa aquí el nombre del icono</a> <hr>
