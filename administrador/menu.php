              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="submenu.php?idmenu=<?php echo $rowmenu->id_categoria; ?>" class="btn btn-default">Ver/Crear Submenus</a></td>
                    <td class="text-right">
                      <?php 
                      if ($estado=="success") {
                         ?><button onclick="desactivarMenu('<?php echo $rowmenu->id; ?>'); return false;" class="btn-xs btn-info">Desactivar</button><?php
                       }else{
                        ?><button onclick="activarMenu('<?php echo $rowmenu->id; ?>'); return false;" class="btn-xs btn-success">Activar</button><?php
                       } ?>
