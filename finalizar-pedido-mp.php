...
$query = mysqli_query($con, "UPDATE pedidos SET metodoPago = 'MercadoPago' WHERE numero_pedido = '$numeroPedido'");
...
//echo "productoscarrito: ".$productosCarrito;
*/
                     ?>
  ...
  <i class="fas fa-6x fa-check-circle" style="color:#62ba43;"></i>
      ...
      <h3 class="text-center textoAzul">Tu pedido <b>#<?php echo $_SESSION['numeroDePedido'] ?></b> está en validación, una vez que confirmemos el pago, te estaremos informando para hacer el envío de tus productos </h3>
                ...
                <div class="row">
                  ...
                  <a href="<?php echo $url; ?>/clientes/historial_pedidos.php"  class="btnAgregarAlCarritoProductos">Ver mis pedidos</a>
                  </div>
                </p>
                  </div>
                </div>
      ...
      <br>
      <i class="textoAzul fas fa-envelope"></i>&nbsp;<a href="mailto:contacto@ferreteriataximaroa.com.mx">contacto@ferreteriataximaroa.com.mx</a><br>
...
//enviamos correo al cliente
          ...
          $to      = $correoe; // Send correo to our user
                    ...
                    <table role="presentation" style="border-collapse:collapse;border:0;border-spacing:0;">
                      ...
                      <tr>
                        <td style="width: 200px" align="center">
                          <a href="http://www.twitter.com/" style="color:#ffffff;"><img style="-webkit-filter: opacity(.9) drop-shadow(0 0 0 white);" src="http://ferreteriataximaroa.com.mx/assets/images/correo/linkedin.jpg" alt="Linkedin" width="28" style="height:auto;display:block;border:0;" /></a>
                        </td>
                        <td style="width: 200px" align="center">
                          <a href="http://www.facebook.com/" style="color:#ffffff;"><img style="  filter: opacity(.9) drop-shadow(0 0 0 white);" src="http://ferreteriataximaroa.com.mx/assets/images/correo/facebook.jpg" alt="Facebook" width="28" style="height:auto;display:block;border:0;" /></a>
                        </td>
                        <td style="width: 200px" align="center">
                          <a href="http://www.facebook.com/" style="color:#ffffff;"><img style="  filter: opacity(.9) drop-shadow(0 0 0 white);" src="http://ferreteriataximaroa.com.mx/assets/images/correo/instagram.jpg" alt="Instagram" width="28" style="height:auto;display:block;border:0;" /></a>
                        </td>
                      </tr>
                    </table>
                  </td>
