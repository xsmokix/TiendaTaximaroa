...
$insertar = mysqli_query($con, "INSERT INTO `preguntas` (`usuario`,`correo`, `pregunta`, `fecha`) VALUES ('$usuario','$correo', '$pregunta', '$fecha');"); 
if (!$insertar) { 
...
echo "1";
          ...
          $subject = 'Información producto'; // Give the correo a subject 
          $message = '
                ...
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                      Alguien está solicitado información de un producto a través de la página web
                    </p>
                    <p><b>Nombre: '.$usuario.' con correo: '.$correo.' pregunto lo siguiente:</p>
                    <p>'.$pregunta.'</p>
                    <p>No olvides responder está pregunta desde el panel de administración -></p>
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="http://ferreteriataximaroa.com.mx/administrador/" style="color:#ee4c50;text-decoration:underline;">Responder pregunta</a></p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0;">
