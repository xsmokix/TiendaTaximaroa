...
if($type == 1){
    ...
    $sql = "SELECT id,nombre,foto1,codigo_fabricante,clave_producto FROM productos where nombre like '%".$searchText."%' OR codigo_fabricante like '%".$searchText."%' OR clave_producto like '%".$searchText."%' order by nombre asc limit 5";
    ...
    while($fetch = mysqli_fetch_assoc($result)){
        ...
        $search_arr[] = array("id" => $id, "nombre" => $nombre, "foto" => $foto, "codigo" => $codigo);
    }
