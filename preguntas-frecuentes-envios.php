...
[type="checkbox"]:not(:checked):focus + label:before {
    ...
    <section class="pt-0">
      <div class="container">
        ...
        <div class="row">
         ...
         <div class="col-lg-8">
           <center><h1 class="mb-0 textoAzul">ENVÍOS</h1></center>
           <br><br>
  ...
  <div class="accordion">
     <?php 
          $preguntas = $con->query("SELECT * FROM preguntas_frecuentes WHERE categoria='envios' AND estado='1'");  
