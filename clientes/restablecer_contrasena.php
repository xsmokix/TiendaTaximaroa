        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
               ...
               <p for="pass">Por favor ingresa una nueva contraseña para tu usuario <b><?php echo $usuario; ?></b></p>
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="password" id="password" placeholder="Nueva contraseña" type="text" required>
                  </div>
                </div>          
                <div class="text-center">
                  <button type="button" onclick="actualizar(); return false;" class="btn btn-primary my-4">Actualizar contraseña</button>
                </div>
                <input class="form-control" name="usuario" id="usuario" type="hidden" value="<?php echo $usuario; ?>" required>
              </form>
            </div>
          </div>
          <div class="row mt-3">
...
function actualizar(){
        ...
        $.ajax(
                                 ...
                                 if (data=="0") {
                                      swal({
                                          title: 'Error',
                                          text: 'No se puedo actualizar la contraseña, intenta nuevamente',
                                          type: 'error'
                                        })
                                 }else{
                                   swal({
                                          title: 'Contraseña',
                                          text: 'actualizada correctamente, ya puedes iniciar sesión con tu usuario <?php echo $usuario; ?> y contraseña',
                                          type: 'success'
                                        }).then(function() {
